...
xticks([0 0.2 0.3 0.5]);yticks( [0 0.1585 0.8913 1]);xlabel('Analog frequency in pi units');ylabel('|H|');grid on
...
subplot(2,2,4); plot(t,ha);axis([0 50 -0.07 0.22]);title('Impulse Response');xlabel('time in seconds');ylabel('ha(t)');grid